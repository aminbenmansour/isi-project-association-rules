...
df = pd.read_csv('market_basket.txt', header=None,delim_whitespace=True,names='ID Product'.split(' '))
...
#preparation des itemsets qui contient 'Aspirin' et 'Aspirin , Eggs'
